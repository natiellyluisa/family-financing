...
//verifica se o usuário existe e se o login está correto
if ($result_user->num_rows > 0) {
    $user = $result_user->fetch_assoc();
    $user_id = $user['id'];

    // Despesas
//busca as despesas do usuário e tras a soma de todas as despesas, de acordo com o id
    ...
    // Receitas
//busca as receitas do usuário e tras a soma de todas as despesas, de acordo com o id
